...
internal partial class BadEnvironmentApi
{
    ...
    private string ExpandEnvironmentVariables([BadParameter(description:"A string containing the names of zero or more environment variables. Each environment variable is quoted with the percent sign character (%).")] string s)
    {
    ...
    private void SetEnvironmentVariable([BadParameter(description:"The name of an environment variable")]string n, [BadParameter(description:"A value to assign to variable")]string v)
    {
