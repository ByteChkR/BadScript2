...
public class BadArrayExtension : BadInteropExtension
{
	...
	{
		RegisterObject<BadArray>("Add",
			a => new BadDynamicInteropFunction<BadObject>("Add",
				(_, o) => Add(a, o),
				"elem"));

		RegisterObject<BadArray>("Clear",
			a => new BadDynamicInteropFunction("Clear",
				_ => Clear(a)));

		RegisterObject<BadArray>("AddRange",
		...
		RegisterObject<BadArray>("Insert",
			a => new BadDynamicInteropFunction<decimal, BadObject>("Insert",
				(_, i, o) => Insert(a, i, o),
				"elem"));

		RegisterObject<BadArray>("InsertRange",
		...
		RegisterObject<BadArray>(BadStaticKeys.ArrayAccessOperatorName,
			a => new BadDynamicInteropFunction<decimal>(BadStaticKeys.ArrayAccessOperatorName,
				...
				"index"));
		RegisterObject<BadArray>(BadStaticKeys.ArrayAccessReverseOperatorName,
