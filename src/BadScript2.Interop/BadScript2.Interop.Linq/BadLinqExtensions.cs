...
public class BadLinqExtensions : BadInteropExtension
{
    ...
    private static BadObject ToTable(BadExecutionContext ctx, IBadEnumerable e, BadFunction keySelector, BadFunction valueSelector)
    {
