...
internal partial class BadHtmlApi
{
    ...
    private string Run(BadExecutionContext context, [BadParameter(description:"The Template File")] string file, [BadParameter(description:"The Model")]BadObject? model = null,[BadParameter(description:"If True, empty text nodes are omitted from the output html")] bool skipEmptyTextNodes = false)
    {
