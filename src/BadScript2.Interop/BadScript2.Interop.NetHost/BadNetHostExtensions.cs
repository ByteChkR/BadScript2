...
public class BadNetHostExtensions : BadInteropExtension
{
	...
	private void AddRequestExtensions()
	{
		...
		RegisterObject<BadHttpRequest>("Content",
			r => CreateInputTable(r.Request.InputStream, r.Request.ContentEncoding));
	}
