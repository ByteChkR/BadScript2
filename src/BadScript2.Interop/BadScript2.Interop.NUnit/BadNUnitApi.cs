...
public class BadNUnitApi : BadInteropApi
{
    ...
    private static BadTable MakeAssert()
	{
		...
		assert.SetFunction<BadNullable<BadObject>, BadNullable<BadObject>, string>("AreEqual",
			(a, b, c) => Assert_AreEqual(a!, b!, c));
		assert.SetFunction<BadNullable<BadObject>, BadNullable<BadObject>, string>("AreNotEqual",
			(a, b, c) => Assert_AreNotEqual(a!, b!, c));
		assert.SetFunction<BadNullable<BadObject>, BadNullable<BadObject>, string>("AreSame",
			(a, b, c) => Assert_AreSame(a!, b!, c));
		assert.SetFunction<BadNullable<BadObject>, BadNullable<BadObject>, string>("AreNotSame",
		...
		assert.SetFunction<BadArray, BadNullable<BadObject>, string>("Contains",
