...
internal partial class BadNUnitAssertApi
{
    ...
    private static void Assert_Throws(BadExecutionContext ctx, [BadParameter(description: "The Function that is expected to throw")] BadFunction func, [BadParameter(description: "The Message")] string message)
    {
    ...
    private static void Assert_AreEqual(
        [BadParameter(description: "The Expected Value")] BadObject? expected,
        [BadParameter(description: "The Actual Value")] BadObject? actual,
    ...
    private static void Assert_Greater([BadParameter(description:"Actual")]decimal a, [BadParameter(description:"Expected")]decimal b, [BadParameter(description: "The Message")]string message)
    {
    ...
    private static void Assert_GreaterOrEqual([BadParameter(description:"Actual")]decimal a, [BadParameter(description:"Expected")]decimal b, [BadParameter(description: "The Message")]string message)
    {
    ...
    private static void Assert_Less([BadParameter(description:"Actual")]decimal a, [BadParameter(description:"Expected")]decimal b, [BadParameter(description: "The Message")]string message)
    {
    ...
    private static void Assert_LessOrEqual([BadParameter(description:"Actual")]decimal a, [BadParameter(description:"Expected")]decimal b, [BadParameter(description: "The Message")]string message)
    {
    ...
    private static void Assert_Contains(
        [BadParameter(description:"The Collection to Check")]BadArray collection,
        [BadParameter(description:"The Object to Check")]BadObject? obj,
        [BadParameter(description: "The Message")]string message)
    {
