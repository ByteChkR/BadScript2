...
internal partial class BadPathApi
{
    ...
    private string ChangeExtension([BadParameter(description: "The path information to modify.")]string path, [BadParameter(description: "The new extension (with or without a leading period). Specify null to remove an existing extension from path")]string extension)
    {
