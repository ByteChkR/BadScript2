...
public class BadInteropTests
{
    ...
    {
        BadInteropEnumerable e = new BadInteropEnumerable(System.Linq.Enumerable.Range(0, 10).Select(x => (BadObject)x));
        ...
        BadObject enumerator = ((BadDynamicInteropFunction)getEnumerator).Invoke(Array.Empty<BadObject>(), BadExecutionContext.Create()).Last();
    ...
    public void Reflection()
    {
        ...
        Assert.That(toString.Invoke(Array.Empty<BadObject>(), BadExecutionContext.Create()).Last(), Is.EqualTo((BadObject)"0.0"));
    }
}