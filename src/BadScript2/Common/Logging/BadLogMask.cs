...
public class BadLogMask
{
    ...
    /// </summary>
    private static readonly Dictionary<string, ulong> s_Masks = new()
    {
        { "None", 0 }, { "Default", 1 }
    };
    ...
    /// </summary>
    public static readonly BadLogMask None = new(0);

    /// <summary>
    ///     Static Helper for the "All" Mask
    /// </summary>
    public static readonly BadLogMask All = new(~0UL);

    /// <summary>
    ///     Static Helper for the "Default" Mask
    /// </summary>
    public static readonly BadLogMask Default = new(1);
    ...
    public static implicit operator BadLogMask(string name)
    {
        ...
        lock (s_Masks)
        {
            if (s_Masks.TryGetValue(name, out var mask))
            {
                return new BadLogMask(mask);
            }
        }
