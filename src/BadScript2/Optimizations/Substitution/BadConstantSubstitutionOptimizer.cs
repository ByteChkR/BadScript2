...
public static class BadConstantSubstitutionOptimizer
{
    ...
    private static bool OnlyContainsConstantsAndConstantVariables(BadConstantSubstitutionOptimizerScope scope, BadExpression expr)
    {
    ...
    private static IEnumerable<BadExpression> Optimize(BadConstantSubstitutionOptimizerScope scope, IEnumerable<BadExpression> expressions)
    {
