...
public class BadDivideAssignExpression : BadBinaryExpression
{
    ...
    public BadDivideAssignExpression(BadExpression left, BadExpression right, BadSourcePosition position) : base(left,
                                                                                                                 right,
                                                                                                                 position
                                                                                                                ) { }
    ...
    public static BadObject Divide(BadObjectReference leftRef,
                                   BadObject left,
                                   BadObject right,
    ...
    public static IEnumerable<BadObject> DivideWithOverride(BadExecutionContext? context,
