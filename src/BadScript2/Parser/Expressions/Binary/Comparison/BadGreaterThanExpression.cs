...
public class BadGreaterThanExpression : BadBinaryExpression
{
    ...
    public BadGreaterThanExpression(BadExpression left, BadExpression right, BadSourcePosition position) : base(left,
                                                                                                                right,
                                                                                                                position
                                                                                                               ) { }
    ...
    public static IEnumerable<BadObject> GreaterThanWithOverride(BadExecutionContext? context,
                                                                 BadObject left,
                                                                 BadObject right,
