...
public class BadInvocationExpression : BadExpression
{
    ...
    /// <exception cref="BadRuntimeException">Gets raised if the object is not a function or the Invocation Override Function is not of type BadFunction</exception>
