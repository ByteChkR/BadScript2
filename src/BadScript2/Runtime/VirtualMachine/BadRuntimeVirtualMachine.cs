        ...
        while (m_InstructionPointer < m_Instructions.Length)
        {
            ...
            switch (instr.OpCode)
            {
                ...
                case BadOpCode.Exp:
                {
                    ...
                    if (m_UseOverrides)
                    {
                        foreach (BadObject o in BadExponentiationExpression.ExpWithOverride(ctx, left, right, instr.Position))
                        {
                            obj = o;
                        }
                    }
                ...
                case BadOpCode.PostInc:
                {
                    ...
                    if (m_UseOverrides)
                    {
                        foreach (BadObject o in BadPostIncrementExpression.IncrementWithOverride(ctx, obj, instr.Position))
                        {
                            result = o;
                        }
                    }
                ...
                case BadOpCode.PostDec:
                {
                    ...
                    if (m_UseOverrides)
                    {
                        foreach (BadObject o in BadPostDecrementExpression.DecrementWithOverride(ctx, obj, instr.Position))
                        {
                            result = o;
                        }
                    }
                ...
                case BadOpCode.PreInc:
                {
                    ...
                    if (m_UseOverrides)
                    {
                        foreach (BadObject o in BadPreIncrementExpression.IncrementWithOverride(ctx, obj, instr.Position))
                        {
                            result = o;
                        }
                    }
                ...
                case BadOpCode.PreDec:
                {
                    ...
                    if (m_UseOverrides)
                    {
                        foreach (BadObject o in BadPreDecrementExpression.DecrementWithOverride(ctx, obj, instr.Position))
                        {
                            result = o;
                        }
                    }
