...
public class BadInterfacePrototype : BadClassPrototype
{
    ...
    public BadInterfacePrototype(string name, BadInterfacePrototype[] interfaces, BadMetaData? metaData, Func<BadInterfaceConstraint[]> constraints) : base(
        name,
        null,
        interfaces,
        metaData
    ...
    {
        return new BadNativeClassPrototype<BadClassPrototype>(
            "Interface",
