...
using BadScript2.Compiler.ExpressionCompilers;
using BadScript2.Compiler.ExpressionCompilers.Access;
using BadScript2.Compiler.ExpressionCompilers.Binary;
using BadScript2.Compiler.ExpressionCompilers.Binary.Comparison;
using BadScript2.Compiler.ExpressionCompilers.Binary.Logic;
using BadScript2.Compiler.ExpressionCompilers.Binary.Logic.Assign;
using BadScript2.Compiler.ExpressionCompilers.Binary.Math;
using BadScript2.Compiler.ExpressionCompilers.Binary.Math.Assign;
using BadScript2.Compiler.ExpressionCompilers.Binary.Math.Atomic;
using BadScript2.Compiler.ExpressionCompilers.Block;
using BadScript2.Compiler.ExpressionCompilers.Constant;
using BadScript2.Compiler.ExpressionCompilers.ControlFlow;
using BadScript2.Compiler.ExpressionCompilers.Function;
using BadScript2.Compiler.ExpressionCompilers.Types;
using BadScript2.Compiler.ExpressionCompilers.Variables;
...
public class BadCompiler
{
    ...
    public IEnumerable<BadInstruction> Compile(BadExpression expression)
    {
        ...
        if (!m_Compilers.TryGetValue(t, out IBadExpressionCompiler compiler))
        {
            if (AllowEval)
            {
                return new[] { new BadInstruction(BadOpCode.Eval, expression.Position, expression) };
            }
