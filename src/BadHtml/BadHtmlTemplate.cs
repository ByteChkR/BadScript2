...
namespace BadHtml
{
    ...
    public class BadHtmlTemplate
    {
        ...
        /// </summary>
        public string Source => m_Source ??= File.ReadAllText(FilePath);
        ...
        public static BadObject FromFile(string path, BadObject args)
        {
        ...
        private BadExecutionContext CreateContext(object model, HtmlDocument document)
        {
            Initialize();
        ...
        public string Run(object model)
        {
            ...
            BadExecutionContext ctx = CreateContext(model, document);

            return Run(ctx, document);
        }
        ...
        /// <param name="model">The Model used in the Transformation</param>
        /// <returns>String Result of the Transformation</returns>
        public static string Run(string filePath, object model)
        {
            return new BadHtmlTemplate(filePath).Run(model);
        }
    }
}